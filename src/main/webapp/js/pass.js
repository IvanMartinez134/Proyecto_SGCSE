    ...
    alerta.textContent = "Tu contraseña es insegura. Te recordamos que debe tener mínimo 8 caracteres, debe contener al menos una letra mayúscula, una letra minúscula, un número y un carácter especial.";
    return;
}
    ...
    event.target.submit(); // Esto envía el formulario al servlet
}, 3000);
});
